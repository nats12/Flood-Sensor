...
{  
  public:
    ...
    // Constructors
    Processor(Sensor *sensor, SDCard *sdCard, Lorawan *lorawan, byte interrputPin, uint32_t delayPeriod = 180000, uint32_t delayPeriodARMode = 60000, int16_t ARModeActivationThreshold = 32000, int16_t ignoreThreshold = 0); 
